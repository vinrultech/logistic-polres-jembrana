...
export default {
  ...
  computed: {
    ...mapGetters({
      items: "asset_tetap/items",
      prev_show: "asset_tetap/prev_show",
      next_show: "asset_tetap/next_show",
      limit: "asset_tetap/limit",
  ...
  methods: {
    changeLimit(val) {
      ...
      this.$store.dispatch("asset_tetap/limit", limit);
    },
    add() {
      this.$router.push("/admin/asset_tetap/create");
    },
    edit(id) {
      this.$router.push(`/admin/asset_tetap/edit/${id}`);
    },
    async remove(id) {
      console.log(id);
      this.$swal({
