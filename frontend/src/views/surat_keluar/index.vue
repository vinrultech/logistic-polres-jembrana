...
import { SURAT_KELUAR } from "../../breadcum";
...
export default {
  ...
  computed: {
    ...mapGetters({
      items: "surat_keluar/items",
      prev_show: "surat_keluar/prev_show",
  ...
  methods: {
    changeLimit(val) {
      ...
      this.$store.dispatch("surat_keluar/limit", limit);
    },
    add() {
      this.$router.push("/admin/surat_keluar/create");
    },
    edit(id) {
